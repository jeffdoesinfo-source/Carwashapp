...
export default function Topbar({ currentUser, locationName, unreadCount = 0, locations = [], selectedLocationId, onLocationChange, onSignOut, onMenuToggle, isMobileMenuOpen }: Props) {
  return (
